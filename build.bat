...
IF %ERRORLEVEL% NEQ 0 EXIT /B 1
%python% prepare.py!para! -c sendMessage.js i18n.js tabs.js str.js string.js cml.js settingsClass.js error.js nc1.js cws.js labelassoc.js cmlpage.js page.js
IF %ERRORLEVEL% NEQ 0 EXIT /B 1
%python% prepare.py!para! -c sendMessage.js i18n.js string.js cml.js settingsClass.js error.js nc1.js cws.js labelassoc.js cmlpage.js options.js
IF %ERRORLEVEL% NEQ 0 EXIT /B 1
%python% language.py
IF %ERRORLEVEL% NEQ 0 EXIT /B 1
